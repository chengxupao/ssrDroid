...
object Constants
{
	...
	object Action
	{
		const val SERVICE = "com.ssrlive.ssrdroid.SERVICE"
		const val CLOSE = "com.ssrlive.ssrdroid.CLOSE"
		const val QUICK_SWITCH = "com.ssrlive.ssrdroid.QUICK_SWITCH"
		const val SCAN = "com.ssrlive.ssrdroid.intent.action.SCAN"
		const val SORT = "com.ssrlive.ssrdroid.intent.action.SORT"
	}
